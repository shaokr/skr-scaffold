...
const cssTemplate =_.template('<link type="text/css" rel="stylesheet" href="<%= url %>" />');
    ...
    apply(compiler) {
        compiler.plugin('compilation', function(compilation) {
            compilation.plugin('html-webpack-plugin-before-html-generation', (htmlPluginData, callback) => {
                const firstData = _.get(htmlPluginData, ['assets', 'chunks', _.keys(htmlPluginData.assets.chunks)[0]], {});
